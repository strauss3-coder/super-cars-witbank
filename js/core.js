...
SC.icon = {
  ...
  wa:s('<path d="M20.5 11.6a8.4 8.4 0 01-12.3 7.4L3.5 20.5l1.6-4.6a8.4 8.4 0 1115.4-4.3z"/><path d="M8.8 8.6c.2-.5.4-.5.7-.5h.5c.2 0 .4 0 .6.5l.7 1.7c.1.3 0 .5-.1.7l-.4.5c-.1.2-.2.4 0 .7a6 6 0 002.7 2.4c.3.1.5 0 .7-.1l.5-.6c.2-.2.4-.2.6-.1l1.6.8c.3.1.4.3.4.5v.6c-.1.5-.6 1-1.1 1.1-.5.2-1.1.2-3.3-.7a9.4 9.4 0 01-4-3.6c-.8-1.4-.8-2.2-.7-2.6.1-.4.4-.8.6-1z"/>'),
